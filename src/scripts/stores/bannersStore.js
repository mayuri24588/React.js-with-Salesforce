...
var bannersStore  = Reflux.createStore({
      ...
      if (!err) {
        records.forEach(function(record) {
          var banner = {
            ...
            "imageUrl": record.get("jobboard420__Image_URL__c"),
            "targetUrl": record.get("jobboard420__Target_URL__c"),
            "active": record.get("jobboard420__Active__c")
          }
  ...
  addBanner: function(banner) {
    ...
    var details = {
      Name: banner.name,
      jobboard420__Image_URL__c: banner.imageUrl,
      jobboard420__Target_URL__c: banner.targetUrl,
      jobboard420__Active__c: 'Yes'
    }
  ...
  toggle: function(bannerId) {
    ...
    var sfdcBanner = new RemoteObjectModel.Banner({
      Id: bannerId,
      jobboard420__Active__c: banner.active
    });
